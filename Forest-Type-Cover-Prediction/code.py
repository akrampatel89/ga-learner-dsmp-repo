...
dataset=dataset.drop('Id',1).copy()
...
y=dataset.drop('Cover_Type',1).copy()
...
# Code Starts Here
subset_train=dataset[cols[0:10]]
...
mask1 = abs(correlation) > upper_threshold
#mask2 = correlation > lower_threshold
mask3 = correlation != 1

corr_var_list=correlation[mask1 & mask3]
# Code ends here
